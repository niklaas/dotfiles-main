...
" Java:
"
" This requires g:eclipse_jdt_ls_data_path, g:eclipse_jdt_ls_jar and
" g:eclipse_jdt_ls_path to be set. The last is the path where you checked out
" Eclipse's language server (see references below); the second is the
" *filename* of the JAR generated by the project; and the first is the
" workspace of your project. For example:
"
"   let g:eclipse_jdt_ls_data_path = '/absolute/path/to/workspace'
"   let g:eclipse_jdt_ls_jar = 'org.eclipse.equinox.launcher_1.5.200.v20180922-1751.jar'
"   let g:eclipse_jdt_ls_path = expand($HOME . '/dev/eclipse.jdt.ls')
"
" References:
"
